...
export function StudentDesk() {
    ...
    const navigate = (v: View) => { setView(v); setSelected(''); setEditing(false); setCreating(false); setCreatingBatchId(''); };
